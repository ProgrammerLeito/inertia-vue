                ...
                <div class="menu-man text-left px-2 whitespace-nowrap">
                    ...
                    <div :class="{'scroll-sidebar h-[calc(100vh-415px)] overflow-x-auto': dataOpenSideBar, 'h-[calc(100vh-205px)] overflow-hidden': !dataOpenSideBar}">
                        ...
                        <details class="py-3 rounded-sm text-gray-400 cursor-pointer">
                            ...
                            <Link :href="route('hservicios.create')" :active="route().current('hservicios.create')" v-show="dataOpenSideBar" class="px-2 flex space-x-2 p-2 ms-4 cursor-pointer hover:text-white whitespace-pre-line"><span class="ml-4">Registrar Hoja de Servicio</span></Link>
                            <Link :href="route('hservicios.index')" :active="route().current('hservicios.index')" v-show="dataOpenSideBar" class="px-2 flex space-x-2 p-2 ms-4 cursor-pointer hover:text-white whitespace-pre-line"><span class="ml-4">Listar Hojas de servicio</span></Link>
