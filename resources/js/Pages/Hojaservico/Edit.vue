                            ...
                            <div class="grid grid-cols-1 gap-y-6 md:grid-cols-2 lg:grid-cols-3 sm:gap-x-8 mb-3">
                                <div>
                                    ...
                                    <div class="mt-4 w-full flex items-center  justify-center">
                                        <img class="p-2 block w-36 h-36 items-center text-sm text-gray-900 border border-gray-200 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:border-gray-600 dark:placeholder-gray-400" :src="'/storage/' + hservicio.foto" alt="Foto actual" >
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-4 w-full flex items-center  justify-center">
                                        <img class="p-2 block w-36 h-36 items-center text-sm text-gray-900 border border-gray-200 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:border-gray-600 dark:placeholder-gray-400" :src="'/storage/' + hservicio.foto2" alt="Foto actual" >
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-4 w-full flex items-center  justify-center">
                                        <img class="p-2 block w-36 h-36 items-center text-sm text-gray-900 border border-gray-200 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:border-gray-600 dark:placeholder-gray-400" :src="'/storage/' + hservicio.foto3" alt="Foto actual" >
                                    </div>
                                </div>
                            </div>
