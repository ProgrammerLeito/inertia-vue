                      ...
                                </div>
                                ...
                                <div class="mt-0 flex justify-center items-center flex-wrap gap-y-0 sm:gap-x-2">
                                    <div class="sm:col-span-1 flex-1 whitespace-nowrap">
                                        <div class="flex flex-wrap gap-4 items-center mb-4 mt-4">
                                            ...
                                            <div v-else>
                                                <span class="text-gray-500">No hay imagen cargada</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sm:col-span-1 flex-1 whitespace-nowrap">
                                        <div class="flex flex-wrap gap-4 items-center mb-4 mt-4">
                                            ...
                                            <div class="mt-2 flex items-center justify-center w-full">
                                                <div v-if="form.foto2 !== ''">
                                                    <img :src="imagePreview2" alt="Vista previa de la foto 2" class="p-2 block w-36 h-36 items-center object-contain text-sm text-gray-900 border border-gray-200 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:border-gray-600 dark:placeholder-gray-400">
                                                </div>
                                                <div v-else>
                                                    <span class="text-gray-500">No hay imagen cargada</span>
                                                </div>
                            ...
                            <div class="d-flex mt-4">
                                <div class="flex flex-wrap gap-x-4 gap-y-4 justify-end">
                                    ...
                                    <ButtonResponsive v-if="!isEditing" @dblclick="editHojaServicio(hservicio)" class="uppercase text-xs">Guadar Hoja de Servicio</ButtonResponsive>
