...
<template>
    <AppLayout title="Crear Rol">
        <template #header>
            <h1 class="font-semibold text-base uppercase text-gray-800 leading-tight dark:text-white">Registrar Roles</h1>
        </template>
                ...
                <div class="p-6 bg-white border-gray-600 rounded-lg dark:bg-gray-800">   
                    <form @submit.prevent="submitForm">
                        <div>
                            ...
                            <TextInput v-model="form.name" type="text" id="name" placeholder="Escribe un rol" class="w-full mt-2 text-sm"/>
                        </div>
